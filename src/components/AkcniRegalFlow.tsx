 ...
 *
 * Vznikl z osmnáctiminutové nahrávky rozhovoru s logistikou: přepis → rozbor
 * → tenhle obrázek → zadání. V lekci „Co je automatizace" je jako druhý
 * příklad vedle kontroly faktur — ta ukazuje hotovou automatizaci, tenhle
 * ukazuje krok předtím, tedy jak se vůbec pozná, co automatizovat.
 *
 ...
 */
export default function AkcniRegalFlow() {
